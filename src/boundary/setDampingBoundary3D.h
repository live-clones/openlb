...
#ifndef SET_DAMPING_BOUNDARY_H
#define SET_DAMPING_BOUNDARY_H
...
#include "dynamics/dampingBoundaryDynamics.h"
...
///Set DampingBoundary for any indicated cells inside the block domain
template<typename T, typename DESCRIPTOR>
