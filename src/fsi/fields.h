...
struct BOUNDARY_FORCE  : public descriptors::FIELD_BASE<0,1> { };
struct BOUNDARY_TORQUE : public descriptors::ROTATION_FIELD_BASE { };
struct BOUNDARY_STRESS : public descriptors::TENSOR { };

struct ELEMENT_FORCE  : public descriptors::FIELD_BASE<0,1> { };
struct ELEMENT_TORQUE  : public descriptors::ROTATION_FIELD_BASE { };
struct ELEMENT_STRESS  : public descriptors::TENSOR { };
...
struct ELEMENT_REFERENCE_POROSITIES : public descriptors::TEMPLATE_FIELD_BASE<std::add_pointer_t,1> { };
