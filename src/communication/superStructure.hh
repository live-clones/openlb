...
SuperStructure<T,D>::SuperStructure(CuboidDecomposition<T,D>& cuboidGeometry,
...
template<typename T, unsigned D>
CuboidDecomposition<T,D>& SuperStructure<T,D>::getCuboidGeometry()
{
  return _cuboidGeometry;
}

template<typename T, unsigned D>
CuboidDecomposition<T,D> const& SuperStructure<T,D>::getCuboidGeometry() const
{
  return _cuboidGeometry;
}
