...
auto x16 = x15 + V{1};
auto x17 = x15 + V{-1};
auto x18 = x6*(-V{0.5}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0) + V{0.5}*cell[0] + V{1}*cell[2] + x11*x16 + x11*x17 + x7 + x8 + V{0.5});
...
cell[2] = -x14*x17 - x18 + V{-0.166666666666667};
...
cell[4] = x14*x16 + x18 + V{-0.166666666666667};
