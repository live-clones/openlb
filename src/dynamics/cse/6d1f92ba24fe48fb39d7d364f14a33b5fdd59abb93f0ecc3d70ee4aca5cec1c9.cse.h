...
auto x16 = x15 + V{-1};
auto x17 = x15 + V{1};
auto x18 = -V{0.5}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0) + V{0.5}*cell[0] + V{1}*cell[4] - x11*x17 + x7 + x8 + V{0.5};
cell[0] = V{0.333333333333333}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0) + V{-0.333333333333333};
cell[1] = -x10*x14 + x6*(-x10*x11 - x13 + x7 - x8) + V{-0.166666666666667};
cell[2] = -x14*x16 + x6*(-x11*x16 + x18) + V{-0.166666666666667};
cell[3] = V{0.166666666666667}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0)*x12 - x6*(V{0.5}*cell[3] - x10*x11 - x13 - x8) + V{-0.166666666666667};
cell[4] = V{0.166666666666667}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0)*x17 - x6*(-x11*x16 + x18) + V{-0.166666666666667};
