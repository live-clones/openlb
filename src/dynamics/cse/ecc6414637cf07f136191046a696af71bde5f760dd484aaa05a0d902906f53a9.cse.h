...
auto x18 = V{0.5}*cell[6];
auto x19 = V{4}*cell.template getFieldComponent<descriptors::VELOCITY>(1);
auto x20 = x19 + V{1};
auto x21 = x19 + V{-1};
auto x22 = x8*(-V{0.5}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0) + V{0.5}*cell[0] + V{1}*cell[2] + x10 + x13*x20 + x13*x21 + x17 + x18 + x9 + V{0.5});
...
cell[2] = -x16*x21 - x22 + V{-0.125};
cell[3] = -x16*x24 + x8*(-x13*x24 - x17 + x18 - x26) + V{-0.125};
cell[4] = V{0.125}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0)*x14 - x8*(V{0.5}*cell[4] - x10 - x12*x13 - x15) + V{-0.125};
cell[5] = x16*x20 + x22 + V{-0.125};
cell[6] = V{0.125}*cell.template getFieldComponent<momenta::FixedDensity::RHO>(0)*x25 - x8*(V{0.5}*cell[6] - x13*x24 - x17 - x26) + V{-0.125};
