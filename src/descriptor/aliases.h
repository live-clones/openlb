...
using DualForcedD3Q19Descriptor = D3Q19<FORCE,F,DJDF>;

using DualForcedMRTD3Q19Descriptor = D3Q19<tag::MRT,FORCE,COORDINATE,F,DJDF>;

using DualPorousD3Q19Descriptor = D3Q19<POROSITY,F,DJDF>;
