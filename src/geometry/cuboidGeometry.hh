...
#ifndef CUBOID_GEOMETRY_HH
#define CUBOID_GEOMETRY_HH
...
//  : _motherCuboid(0,0,0,0)
//  , _cuboids{_motherCuboid}
//  , _periodicityOn{}
//  , clout(std::cout, "CuboidGeometry")
//{ }

template <typename T, unsigned D>
CuboidGeometry<T,D>::CuboidGeometry(Vector<T,D> origin, T deltaR, Vector<int,D> extent, int nC)
...
template <typename T, unsigned D>
CuboidGeometry<T,D>::CuboidGeometry(const Cuboid<T,D>& motherCuboid, int nC)
  : CuboidGeometry(motherCuboid.getOrigin(), motherCuboid.getDeltaR(), motherCuboid.getExtent(), nC)
{ }

template <typename T, unsigned D>
CuboidGeometry<T,D>::CuboidGeometry(IndicatorF<T,D>& indicatorF, T voxelSize, int nC)
...
template <typename T, unsigned D>
CuboidGeometry<T,D>::CuboidGeometry(IndicatorF<T,D>& indicatorF, T voxelSize, int nC, std::string minimizeBy)
...
template <typename T, unsigned D>
Cuboid<T,D>& CuboidGeometry<T,D>::get(int iC)
{
  return _cuboids[iC];
}

template <typename T, unsigned D>
const Cuboid<T,D>& CuboidGeometry<T,D>::getMotherCuboid() const
{
  return _motherCuboid;
}

template <typename T, unsigned D>
Cuboid<T,D>& CuboidGeometry<T,D>::getMotherCuboid()
{
  return _motherCuboid;
}

template <typename T, unsigned D>
Vector<T,D> CuboidGeometry<T,D>::getPhysR(LatticeR<D+1> latticeR) const
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::setPeriodicity(Vector<bool,D> periodicity)
{
  _periodicityOn = periodicity;
}

template <typename T, unsigned D>
std::set<int> CuboidGeometry<T,D>::getNeighborhood(int cuboid, int overlap) const
{
  std::set<int> dummy;
  if constexpr (D == 3) {
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMinRatio() const
{
  T minRatio = 1.;
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMaxRatio() const
{
  T maxRatio = 1.;
  for (unsigned i = 0; i < _cuboids.size(); i++) {
...
template <typename T, unsigned D>
Vector<T,D> CuboidGeometry<T,D>::getMinPhysR() const
{
...
template <typename T, unsigned D>
Vector<T,D> CuboidGeometry<T,D>::getMaxPhysR() const
{
  Vector<T,D> output(_cuboids[0].getOrigin());
  for (unsigned iD=0; iD < D; ++iD) {
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMinPhysVolume() const
{
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMaxPhysVolume() const
{
...
template <typename T, unsigned D>
std::size_t CuboidGeometry<T,D>::getMinLatticeVolume() const
{
...
template <typename T, unsigned D>
std::size_t CuboidGeometry<T,D>::getMaxLatticeVolume() const
{
...
template <typename T, unsigned D>
std::size_t CuboidGeometry<T,D>::getMinLatticeWeight() const
{
...
template <typename T, unsigned D>
std::size_t CuboidGeometry<T,D>::getMaxLatticeWeight() const
{
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMinDeltaR() const
{
...
template <typename T, unsigned D>
T CuboidGeometry<T,D>::getMaxDeltaR() const
{
...
template <typename T, unsigned D>
bool CuboidGeometry<T,D>::operator==(CuboidGeometry<T,D>& rhs)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::remove(int iC) {
  _cuboids.erase(_cuboids.begin() + iC);
}


template <typename T, unsigned D>
void CuboidGeometry<T,D>::remove(IndicatorF<T,D>& indicatorF)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::removeByWeight()
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::shrink(int iC, IndicatorF<T,D>& indicatorF)
{
  if constexpr (D == 3) {
    LatticeR<D+1> latticeR{};
    bool inside[1] {};
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::shrink(IndicatorF<T,D>& indicatorF)
{
  for (int iC=0; iC < size(); ++iC) {
  ...
  _motherCuboid = Cuboid<T,D>(minPhysR, minDelataR, (maxPhysR - minPhysR) / minDelataR + 0.5);
}

template <typename T, unsigned D>
void CuboidGeometry<T,D>::refine(int factor)
{
...
template <typename T, unsigned D>
bool CuboidGeometry<T,D>::tryRefineTo(T goalDeltaR)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::split(int iC, int p)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::splitRegular(int iC, int width)
{
  Cuboid<T,D> temp(_cuboids[iC]);
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::splitByWeight(int iC, int p, IndicatorF<T,D>& indicatorF) requires (D == 3)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::splitFractional(int iC, int iD, std::vector<T> fractions)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::setWeights(IndicatorF<T,D>& indicatorF) requires (D == 3)
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::print() const
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::printExtended()
{
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::writeToExistingFile(std::string completeFileName, LoadBalancer<T>& loadBalancer)
{
  std::ofstream fout;
...
template <typename T, unsigned D>
void CuboidGeometry<T,D>::writeToFile(std::string fileName, LoadBalancer<T>& loadBalancer)
{
...
// TODO: Move this method to Cuboid<T,D> class
/// Helper Function to create cuboid parameters for XML tag
template <typename T, unsigned D>
std::string CuboidGeometry<T,D>::_cuboidParameters(Cuboid<T,D> const& cub)
{
  std::stringstream ss;
