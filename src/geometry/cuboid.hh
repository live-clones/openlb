...
{
  auto loc0 = util::max(_origin-overlap*_delta, min);
  auto loc1 = util::min(_origin+(_extent+overlap-1)*_delta, max);
  return loc1 >= loc0;
}
  ...
  if (rest==0) {
    ...
    if (nZ>nY && nZ>nX) {
      ...
      if (restY==0) {
        ...
        CuboidGeometry<T,2> helpG({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restX);
      ...
      CuboidGeometry<T,2> helpG0({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restX);
      ...
      restX = rest/bestIy;
      CuboidGeometry<T,2> helpG1({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restX);
      yN_child = 0;
    ...
    // add in x than in y direction
      ...
      if (restY==0) {
        ...
        CuboidGeometry<T,2> helpG({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restZ);
      ...
      CuboidGeometry<T,2> helpG0({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restZ);
      ...
      CuboidGeometry<T,2> helpG1({_origin[0], _origin[2]}, _delta, {_extent[0], _extent[2]}, bestIx*bestIz+restZ);
      yN_child = 0;
    ...
    // add in y than in x direction
      ...
      if (restX==0) {
        ...
        CuboidGeometry<T,2> helpG({_origin[2], _origin[1]}, _delta, {_extent[2], _extent[1]}, bestIz*bestIy+restZ);
      ...
      CuboidGeometry<T,2> helpG0({_origin[2], _origin[1]}, _delta, {_extent[2], _extent[1]}, bestIz*bestIy+restZ);
      ...
      restZ = rest/bestIx;
      CuboidGeometry<T,2> helpG1({_origin[2], _origin[1]}, _delta, {_extent[2], _extent[1]}, bestIz*bestIy+restZ);
      xN_child = 0;
