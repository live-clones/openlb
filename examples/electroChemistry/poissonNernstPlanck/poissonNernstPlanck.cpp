...
int main( int argc, char* argv[] )
{
  ...
  int startN = 20;
  int maxN = 81;
  // switch on if your problem is transient and you need convergence of Poisson equation inside of each global time step.
  bool poissonLoop = false;
  ...
  for(int N = startN; N < maxN; N *= 2){
    ...
    simulatePoissonNernstPlanck3D(N, poissonLoop, gplot);
  }
