...
int main( int argc, char *argv[] )
{
  ...
  MyCase::ParametersD myCaseParameters;
  {
    ...
    myCaseParameters.set<NU_VAPOR        >(1.532e-5);    // physViscosity H2O lattice [physical units]
    myCaseParameters.set<NU_LIQUID       >(1e-6);        // physViscosity N2+O2 lattice [physical units]
